 ...
 * @author ASUS
 */
public class SuaGiangVien extends javax.swing.JFrame {

    QLGiangVien qlgv;
    GiangVien gv;
    /**
     * Creates new form SuaGiangVien
     */
    public SuaGiangVien(String gvID) throws ParseException {
        initComponents();
        qlgv = new QLGiangVien();
        gv = qlgv.DocGVByID(gvID);
        txtMaHV.setText(gv.getMa_giang_vien());
        txtMaHV.setEnabled(false);
        txtTenHV.setText(gv.getTen_giang_vien());
        Date date = new SimpleDateFormat("dd/MM/yyyy").parse(gv.getNgay_sinh());        
        dateNgaySinhHV.setDate(date);
        //dateNgaySinhHV.setDateFormatString(hv.getNgay_sinh());
        if (gv.getPhai().equals("Nam")) {
            rdoNam.setSelected(true);
        }else{
            rdoNu.setSelected(true);
        }
        txtDiaChi.setText(gv.getDia_chi());
        txtSDTHV.setText(String.valueOf(gv.getLien_he())); 
        txtLuong.setText(String.valueOf(gv.getLuong_cb())); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaGiangVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
